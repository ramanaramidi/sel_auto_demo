...
public class Constants {
    public  static final String TRACKER_DATA = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\tracker_data.xlsx";
    public static final String IMAGE_FILE_UPLOAD = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\uploads\\simpleImage.png";
    public static final String EXCEL_FILE_UPLOAD = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\uploads\\sample.xlsx";
    public  static final String SECTOR_IMPORT_DATA = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\imports\\sector_imports.csv";
    public  static final String MSM_IMPORT_DATA = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\imports\\msm_imports.csv";
    public  static final  String Ring_IMPORT_DATA = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\imports\\ring_imports.csv";
   // public  static final String SECTOR_IMPORT_EXE = System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\imports\\SectorImport.exe";
