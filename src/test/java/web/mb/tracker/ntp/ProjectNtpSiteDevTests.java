...
public class ProjectNtpSiteDevTests extends BaseTest {
    ...
    public void uploadRegulatoryAndConstructionDocSiteDev(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3800_PRE_NTP", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3800_PRE_NTP Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2475_FINAL_RFDS_ISSUED", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2475_FINAL_RFDS_ISSUED Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2275_FIN_CNST_DR_APP", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2275_FIN_CNST_DR_APP Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3850_BOM_IN_BAT", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3850_BOM_IN_BAT Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_1400_STRUCTURAL_COM", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_1400_STRUCTURAL_COM Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_1550_MNT_ANLSIS_RECD", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_1550_MNT_ANLSIS_RECD Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_PORT_MATRIX", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_PORT_MATRIX Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3675_BP_APPROVED", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3675_BP_APPROVED Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_4000_LL_NTP", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_4000_LL_NTP Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_GONOGO_CHKLST", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_GONOGO_CHKLST Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_ADD_NTP_DOC", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_ADD_NTP_DOC Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2525_REC_ULD_TAIR_ANS", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2525_REC_ULD_TAIR_ANS Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2575_REC_UPD_NEPA_STDY", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2575_REC_UPD_NEPA_STDY Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2600_SHPO", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2600_SHPO Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2625_THPO", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2625_THPO Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2650_PAL", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2650_PAL Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2675_BIO_END_SPEC_STDY", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2675_BIO_END_SPEC_STDY Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2725_WETLAND_DEL", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2725_WETLAND_DEL Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2775_AM_SCREEN", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2775_AM_SCREEN Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2825_REC_AM_DETUNE", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2825_REC_AM_DETUNE Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2925_EME_SIGN_PLAN", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2925_EME_SIGN_PLAN Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2950_FAA_CRANE_NOT", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2950_FAA_CRANE_NOT Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_2975_TOP_OUT_NOT", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_2975_TOP_OUT_NOT Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3025_7460_1", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3025_7460_1 Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3050_FAA_DET", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3050_FAA_DET Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3075_FCC_COMP_LTR", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3075_FCC_COMP_LTR Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3100_TOWER_LIGHTING", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3100_TOWER_LIGHTING Document should be uploaded");
        softAssert.assertTrue(projectHelper.uploadDocument(PROJECT_ACTIVE_SITE_DEV.trackerId.toString(),"PJ_3250_PHASE_1_REC", Constants.IMAGE_FILE_UPLOAD,"simpleImage.png"),"PJ_3250_PHASE_1_REC Document should be uploaded");
