...
public class PORTests  extends BaseTest {
    ...
    public void login(Method method) throws Exception {
        ...
        String ringIdNewPor = "PP" + MiscHelpers.getRandomString(5, true).toUpperCase();
...
//        VALID_RING_NON_PRIMARY_BUILD_SITE = ringId;
    ...
    public void verifyAllPORID_Por() throws Exception {
        ...
        softAssert.assertTrue(porTrackerPage.getPORIDCount()>0, "There is at-least one POR");
        if(porTrackerPage.getPORIDCount()>0){
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:POR ID"),"Value Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("M:Market"),"Value Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:Program Name"),"Value Should Be Present");
        }
        softAssert.closeAssert();
    }


    @Test(groups = {"Integration"},description = "Do NOT Enter the Mandatory fields in POR and click on Apply.",priority = 3)
    public void verifyMandatoryFieldsAlertMessages_Por(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        porTrackerPage= mainSideMenu.goToPorTrackerPage();
        ...
        porTrackerPage = addPORPage.verifyMandatoryMessageAlert(ACTIVE_RING_AND_SITE);
        softAssert.assertTrue(initialPorCount == porTrackerPage.getPORIDCount(),"POR Count Should Match");
        softAssert.closeAssert();
    }
...
//        // porTrackerPage.clickAddNewPORButton();
        ...
        if(porData != null){
            ...
            String response = porTrackerPage.searchForValueInGrid("POR:POR Request Type","POR:POR ID",porData.porId);
            softAssert.assertContains(response,"New Request in Process","Request Type Should Match");
            System.out.println(":::"+response);
            response = porTrackerPage.searchForValueInGrid("POR:POR Request Queue","POR:POR ID",porData.porId);
            softAssert.assertContains(response,"Region POR Submission","Request Queue Should Match");
            System.out.println(":::"+response);
            response = porTrackerPage.searchForValueInGrid("POR:Created By","POR:POR ID",porData.porId);
            softAssert.assertContains(response,superUser.getNtCode(),"created By Should Match::"+response);
            System.out.println(":::"+response);
            response = porTrackerPage.searchForValueInGrid("POR:Created Date","POR:POR ID",porData.porId);
            softAssert.assertContains(response, MiscHelpers.currentDateTime("MM/dd/yyyy"),"Created Date should Match::"+response );
            System.out.println(":::"+response);
            response = porTrackerPage.searchForValueInGrid("POR:Last Modified By","POR:POR ID",porData.porId);
            softAssert.assertContains(response,superUser.getNtCode(),"Last Modified By Should Match::"+response );
            System.out.println(":::"+response);
            response = porTrackerPage.searchForValueInGrid("POR:Last Modified Date","POR:POR ID",porData.porId);
           // softAssert.assertContains(response, MiscHelpers.currentDateTime("MM/dd/yyyy"),"Last Modified Date Should Match::"+response );
            System.out.println(":::"+response);
    ...
    public void createNewPORAndUpdateRequestQueue_Por(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        porTrackerPage= mainSideMenu.goToPorTrackerPage();
        ...
        if(porData!=null) {
            ...
            response = porTrackerPage.searchForValueInGrid("POR:POR Request Queue", "POR:POR ID", porData.porId);
            System.out.println(":::"+response);
            softAssert.assertContains(response, "POR Request Complete", "Request Queue Should Match");
            System.out.println(":::"+response);
            response = porTrackerPage.searchForValueInGrid("POR:Last Modified By", "POR:POR ID", porData.porId);
            softAssert.assertContains(response, superUser.getNtCode(), "Last Updated By Should Match::" + response);

            //DELETE THE CREATED POR AS PART OF TEAR DOWN
            porHelper.getPorTrackerIdsAndDelete(porData);

            // softAssert.assertTrue(!ProjectID.equals(""), "Project Id is created and displayed under Project ID field Successfully.");
        }
        else {
            softAssert.assertTrue(false,"Seems like an issue occurred when creating the POR");
        }
    ...
    public void createNewPORWithBuildStatusNotPrimary_Por(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        porTrackerPage= mainSideMenu.goToPorTrackerPage();
        Por porData = new Por(ACTIVE_RING_AND_SITE);
        porData = porHelper.createAPor(porData);
        if(porData!=null) {
            ...
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("M:Market"), "Value M:Market Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:Program Name"), "Value POR:Program Name Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:POR Request Type"), "Value POR:POR Request Type Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:POR Request Queue"), "Value POR:POR Request Queue Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:Created By"), "Value POR:Created By Should Be Present");
            softAssert.assertTrue(porTrackerPage.isValuePresentInGrid("POR:Created Date"), "Value POR:Created Date Should Be Present");
            ...
            softAssert.assertTrue(projectId.equals(ExpectedProjectID), "Project ID not generated");
            porHelper.getPorTrackerIdsAndDelete(porData);
        }
        else {
            softAssert.assertTrue(false,"Seems like an issue occurred when creating the POR");
    ...
    @Test(groups = {"Integration"},description = "Enter the Mandatory fields in POR Add Page and click on Apply",priority = 5)
    public void createNewPORWithRingStatusNew_Por(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        porTrackerPage= mainSideMenu.goToPorTrackerPage();
    ...
    @Test(groups = {"Integration"},description = "Enter the Mandatory fields in POR Add Page and click on Apply",priority = 5)
    public void createNewPORWithRingStatusAndSiteStatusNew_Por(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        porTrackerPage= mainSideMenu.goToPorTrackerPage();
    ...
    @Test(groups = {"Integration"},description = "Enter the Mandatory fields in POR Add Page and click on Apply",priority = 5)
    public void createNewPORWithRingStatusActiveAndSiteStatusNew_Por(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        porTrackerPage= mainSideMenu.goToPorTrackerPage();
    ...
    public void createdPORDateByASC_Por(Method method) throws Exception {
        ...
        softAssert.assertTrue(PORIDCount1==PORIDCount, "POR  created Date Sorting Done Successfully");
        softAssert.closeAssert();
