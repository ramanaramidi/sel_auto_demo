...
public class EdbProducerTest extends BaseTest {
    ...
    private void generateData(){
        ...
        String newSiteRingId = "AU" + MiscHelpers.getRandomString(5, true).toUpperCase();
        NEW_SITE = siteHelper.createNewRingAndSite(new Ring("Active", newSiteRingId, "Macro"),new Site(newSiteRingId,"Candidate","New Site"));
...
//    @Test(groups = {"Integration"},description = "verifyEdbMessagePostRingCreation_Edb",priority = 2)
//    public void verifyEdbMessagePostNewRingCreation_Edb(Method method) throws Exception {
...
//    }
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostRingCreation_Edb",priority = 2)
    public void verifyEdbMessagePostActiveRingCreation_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        edbProducerTrackerPage.searchForValue(ACTIVE_RING.ringId, "EPM:Tracker Key");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Created Timestamp (PT)"),"Timestamp");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:User ID"),"User");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Message Type"),"Message Type");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker ID"),"Tracker ID");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker Key"),"Tracker Key");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Producer Message"),"Producer Message");
        System.out.println(" EPM:Created Timestamp (PT)"+edbProducerTrackerPage.searchForValueInGrid("EPM:Created Timestamp (PT)",1));
        System.out.println("User ID "+edbProducerTrackerPage.searchForValueInGrid("User ID",1));
        System.out.println("EPM:Message Type "+edbProducerTrackerPage.searchForValueInGrid("EPM:Message Type",1));
        System.out.println("EPM:Producer Message "+edbProducerTrackerPage.searchForValueInGrid("EPM:Producer Message",1));
        softAssert.closeAssert();
    }

    @Test(groups = {"Integration"},description = "verifyEdbMessagePostSiteCreation_Edb",priority = 2)
    public void verifyEdbMessagePostActiveSiteCreation_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        edbProducerTrackerPage.searchForValue(ACTIVE_SITE.siteId, "EPM:Tracker Key");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Created Timestamp (PT)"),"Timestamp");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:User ID"),"User");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Message Type"),"Message Type");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker ID"),"Tracker ID");
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostSiteUpdate_Edb",priority = 4)
    public void verifyEdbMessagePostSiteUpdate_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        ...
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker Key"),"Tracker Key");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Producer Message"),"Producer Message");
        System.out.println(" EPM:Created Timestamp (PT)"+edbProducerTrackerPage.searchForValueInGrid("EPM:Created Timestamp (PT)",2));
        System.out.println("User ID "+edbProducerTrackerPage.searchForValueInGrid("User ID",2));
        System.out.println("EPM:Message Type "+edbProducerTrackerPage.searchForValueInGrid("EPM:Message Type",2));
        System.out.println("EPM:Producer Message "+edbProducerTrackerPage.searchForValueInGrid("EPM:Producer Message",2));
        softAssert.closeAssert();
    }
...
//    }
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostNewSiteCreation_Edb",priority = 4)
    public void verifyEdbMessagePostNewPorCreation_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        sleepFor(10);
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostNewSiteCreation_Edb",priority = 4)
    public void verifyEdbMessagePostUpdatePor_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostRingCreation_Edb",priority = 40)
    public void verifyEdbMessagePostActiveProjectCreation_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        edbProducerTrackerPage.searchForValue(PROJECT_ACTIVE.projectId, "EPM:Tracker Key");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Created Timestamp (PT)"),"Timestamp");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:User ID"),"User");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Message Type"),"Message Type");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker ID"),"Tracker ID");
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostNewSiteCreation_Edb",priority = 4)
    public void verifyEdbMessagePostNewProject_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        sleepFor(10);
        edbProducerTrackerPage.searchForValue(PROJECT_NEW.projectId, "EPM:Tracker Key");
        softAssert.assertFalse(edbProducerTrackerPage.isValuePresentInGrid("EPM:Created Timestamp (PT)"),"Timestamp");
        softAssert.assertFalse(edbProducerTrackerPage.isValuePresentInGrid("EPM:User ID"),"User");
        softAssert.assertFalse(edbProducerTrackerPage.isValuePresentInGrid("EPM:Message Type"),"Message Type");
        softAssert.assertFalse(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker ID"),"Tracker ID");
    ...
    @Test(groups = {"Integration"},description = "verifyEdbMessagePostNewSiteCreation_Edb",priority = 4)
    public void verifyEdbMessagePostNewSector_Edb(Method method) throws Exception {
        AssertionsUtil softAssert = new AssertionsUtil();
        edbProducerTrackerPage = mainSideMenu.goToEdbProducerPage();
        sleepFor(10);
        edbProducerTrackerPage.searchForValue(SECTOR_NEW.sectorId, "EPM:Tracker Key");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Created Timestamp (PT)"),"Timestamp");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:User ID"),"User");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Message Type"),"Message Type");
        softAssert.assertTrue(edbProducerTrackerPage.isValuePresentInGrid("EPM:Tracker ID"),"Tracker ID");
