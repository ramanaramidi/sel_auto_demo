...
public class EdbService {
    ...
    public ApiResponse updateExistingSector(Sector sector) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                baseUrl + EdbConstants.EDB_CONSUMER_TRACKER_URL,
                null,
                headers,
                edbRequestBuilder.updateExistingSectorEDB(sector)
        );
    ...
    public ApiResponse addToExistingSectorEDB(Sector sector, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.addToExistingSectorEDB(sector, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse removeFromExistingSectorEDB(Sector sector, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.removeFromExistingSectorEDB(sector, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse createNewRingEDB(Ring ring, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.createNewRingEDB(ring, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse updateRingLatLongEDB(Ring ring, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.updateRingLatLongEDB(ring, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse updateSiteLatLongEDB(Site site, Users user) {
        logReport.info(" Start of ----updateSiteLatLongEDB");
        EdbRequestBuilder edbRequestBuilder = new EdbRequestBuilder();
        Map<String, String> headers = edbRequestBuilder.getHeader();
        ApiRequest requestDetails = new ApiRequest(
                baseUrl + EdbConstants.EDB_CONSUMER_TRACKER_URL,
                null,
                headers,
                edbRequestBuilder.updateSiteLatLongEDB(site, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
        logReport.info(" End of ----updateSiteLatLongEDB");
        return responseDetails;
    }
    ...
    public ApiResponse createNewSectorEDB(Sector sector, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.createNewSectorEDB(sector, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse createNewSiteEDB(Site site, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.createNewSiteEDB(site, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse moveExistingSiteEDB(Site site, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.moveExistingSiteEDB(site, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
    ...
    public ApiResponse createElementEventSiteEDB(Site site, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.createElementEventSiteEDB(site, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
        logReport.info(" End of ----moveExistingSiteEDB");
    ...
    public ApiResponse updateElementOnAirOffAirSiteStatusEDB(Site site) {
        logReport.info(" Start of ----updateElementOnAirOffAirSiteStatusEDB");
        EdbRequestBuilder edbRequestBuilder = new EdbRequestBuilder();
        Map<String, String> headers = edbRequestBuilder.getHeader();
        ApiRequest requestDetails = new ApiRequest(
                baseUrl + EdbConstants.EDB_CONSUMER_TRACKER_URL,
                null,
                headers,
                edbRequestBuilder.updateElementOnAirOffAirSiteStatusEDB(site)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
        logReport.info(" End of ----updateElementOnAirOffAirSiteStatusEDB");
        return responseDetails;
    }
    ...
    public ApiResponse createElementEventSectorEDB(Site site, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.createElementEventSectorEDB(site, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
        logReport.info(" End of ----moveExistingSiteEDB");
    ...
    public ApiResponse createPierMessageEDB(Site site, Users user) {
        ...
        ApiRequest requestDetails = new ApiRequest(
                ...
                null,
                headers,
                edbRequestBuilder.createPierMessageEDB(site, user)
        );
        ApiResponse responseDetails = RestClientLib.post(requestDetails);
        System.out.println("API RESPONSE:: " + responseDetails.responseBody);
        logReport.info(" End of ----moveExistingSiteEDB");
