...
public class ProjectService {
    ...
    public ApiResponse getProjectTrackerIdsForSite(String id){
        ...
        ApiRequest requestDetails = new ApiRequest(baseUrl+ ProjectConstants.CREATE_PROJECT_TRACKER_URL,params,headers, null);
        ApiResponse responseDetails = RestClientLib.get(requestDetails);
        logReport.info(" End of ----getProjectTrackerIdsForSite");
        return responseDetails;
    }

    public ApiResponse getProjectTrackerIdsForProjectIdWithCustomFields(String id,String fields){
        logReport.info(" Start of ----getProjectTrackerIdsForProjectIdWithCustomFields");
        ProjectRequestBuilder projectRequestBuilder = new ProjectRequestBuilder();
        Map<String,String> headers = projectRequestBuilder.getHeader();
        Map<String,String> params = new HashMap<>();
        ...
        ApiRequest requestDetails = new ApiRequest(baseUrl+ ProjectConstants.CREATE_PROJECT_TRACKER_URL,params,headers, null);
        ApiResponse responseDetails = RestClientLib.get(requestDetails);
        logReport.info(" End of ----getProjectTrackerIdsForProjectIdWithCustomFields");
        return responseDetails;
    }
    ...
    public ApiResponse activateProject(String id){
        ...
        Map<String,String> params = new HashMap<>();
        params.put("TRACKOR_KEY",id);
        ApiRequest requestDetails = new ApiRequest(baseUrl+ ProjectConstants.CREATE_PROJECT_TRACKER_URL,params,headers, ProjectConstants.ACTIVATE_PROJECT);
        ApiResponse responseDetails = RestClientLib.put(requestDetails);
        logReport.info(" End of ----activateProject");
        return responseDetails;
    }

    public ApiResponse uploadNTPFile(String trackerId,String field, String path,String fileName){
        ...
        ApiResponse responseDetails = RestClientLib.post(requestDetails,fileName,path);
